package com.example.blogapp.ui.home.home
...
import com.example.blogapp.presentation.HomeScreenViewHolderFactory
...
class HomeScreenFragment : Fragment(R.layout.fragment_home_screen) {
   ...
   private lateinit var binding : FragmentHomeScreenBinding
    private val ViewModel by viewModels<HomeScreenViewModel>{
        HomeScreenViewHolderFactory(HomeScreenRepoImpl(HomeScreenDataSource()))
    }
